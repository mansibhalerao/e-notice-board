...
public class HodAccountCreation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<body>");
            out.println("<pre>");
            out.println("<h2>Account Created for the HOD "+name+" of the department "+dept+"</h2>");
            out.println("<a href=HodRegi.jsp>Create another account</a>");
            out.println("<a href=admin_home.jsp>go back to admin home<a>");
            out.println("</pre>");
            out.println("</body>");
            out.println("</html>");
